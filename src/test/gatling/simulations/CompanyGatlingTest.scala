...
class CompanyGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Company entity")
        ...
        .repeat(2) {
            ...
            .post("/api/companies")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "companyName":"SAMPLE_TEXT", "regAddress":"SAMPLE_TEXT", "linkAddress":"SAMPLE_TEXT", "businessLicense":"SAMPLE_TEXT", "codeCertificate":"SAMPLE_TEXT", "orgType":null}""")).asJSON
            .check(status.is(201))
